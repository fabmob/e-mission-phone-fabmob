...
for x in 29,small 58,small@2x 87,small@3x 40,40 80,40@2x 120,40@3x 50,50 100,50@2x 60,60 120,60@2x 180,60@3x 72,72 144,72@2x 76,76 152,76@2x 167,83.5@2x 1024,1024 ; do
	IFS=",";
	set $x;
	unset IFS;
