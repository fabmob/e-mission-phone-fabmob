...
.controller('MetricsCtrl', function($scope, $ionicActionSheet, $ionicLoading,
    ...
    $ionicModal.fromTemplateUrl('templates/fabmob/metrics/metrics-control-fabmob.html', { // fabmob
      scope: $scope,
   ...
   var getAggMetricsFromServer = function() {
      ...
      var getMetricsResult = $http.post(
        "http://145.239.101.212:8080/result/metrics/timestamp", // fabmob
        clonedData)
      return getMetricsResult;
   }
